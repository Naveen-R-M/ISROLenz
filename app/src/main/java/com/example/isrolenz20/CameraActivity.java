...
import com.example.isrolenz20.env.ImageUtils;
import com.example.isrolenz20.env.Logger;
import com.example.isrolenz20.tflite.Classifier;
import com.example.isrolenz20.tflite.Classifier.Device;
import com.example.isrolenz20.tflite.Classifier.Model;
import com.example.isrolenz20.tflite.Classifier.Recognition;
...
public abstract class CameraActivity extends AppCompatActivity
    ...
    private View view;
    private ImageButton btn2,imgbtn,btn3;
    private int count;
    private TextToSpeech tts;
    private ClassifierActivity classifierActivity;
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        btn2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                count++;
                String data = recognitionTextView.getText().toString();
        ...
        swipe1.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                startActivity(new Intent(CameraActivity.this,ClassifierActivity.class));
        ...
        btn3 = findViewById(R.id.img_btn3);

        btn3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String mail="naveen.rm.551@gmail.com";
                String sub = "JavaMailAPI";
                String msg="Hello";

//                JavaMailAPI javaMailAPI = new JavaMailAPI(CameraActivity.this,mail,sub,msg);
//                javaMailAPI.execute();
        ...
        if (results != null && results.size() >= 3) {
            ...
            if (recognition != null) {
                if (recognition.getTitle() != null) {
                    ...
                    label = recognitionTextView.getText().toString();
                }
